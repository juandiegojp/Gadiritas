...
<body>
    <div id="left-div">
        <div id="semi-transparent-div">
            ...
            <h2>
                Si te gusta el turisimo y enseñar a nuestros clientes todos y cada uno de los rincones, historia y actividades que
    ...
    <div id="right-div">
        <form action="" method="POST" enctype="multipart/form-data" id="trabajaNosotros">
            ...
            <div>
                ...
                <input type="text" id="nombre" name="nombre" placeholder="Juan José Valladares del Olmo" required
                    class="inputTrabajo">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="tel" id="tlf" name="tlf" placeholder="623451789" required class="inputTrabajo">
            </div>
            <div>
            ...
            <div class="w-1/2 mb-6">
                <label for="cv">Inserta aquí su CV:</label>
