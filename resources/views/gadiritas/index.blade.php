    ...
    <div class="mx-2">
        ...
        <div class="grid gap-2 grid-cols-3 w-full place-content-between">
            <div
                ...
                <a href="#">
                    <img class="p-8 rounded-t-lg"
                        src="https://3.bp.blogspot.com/-YS9WGXB3TDs/Up2x8_QH5pI/AAAAAAAAlaM/lJVHR6rt34g/s1600/Vista+a%25C3%25A9rea.jpg"
                        alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
            ...
            <div
                class="w-full max-w-sm bg-white border-solid border-2 border-indigo-600 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="p-8 rounded-t-lg h-60 w-72"
                        src="https://www.andalusiatourtravel.com/uploads/actividades/88/20150314144106bodega-barbadillo-manzanilla-sanlucar.jpg"
                        alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Bodega Barbadillo
                        </h5>
                    </a>
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-900 dark:text-white">$599</span>
            ...
            <div
                ...
                <a href="#">
                    <img class="p-8 rounded-t-lg h-60 w-72"
                        src="https://www.lacostadecadiz.com/wp-content/uploads/2022/07/FB_IMG_1656867000170.jpg"
                        alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
