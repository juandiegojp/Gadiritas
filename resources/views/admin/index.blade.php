...
<div class="flex items-start justify-between">
    <div class="w-1/2 p-5 mb-4 border border-gray-100 rounded-lg bg-gray-50">
        <h2 class="mb-4 text-3xl font-semibold text-center underline">Nuevos usuarios</h2>
    ...
    <div class="w-1/2 p-5 mb-4 border border-gray-100 rounded-lg bg-gray-50">
        <h2 class="mb-4 text-3xl font-semibold text-center underline">Nuevas reservas</h2>
