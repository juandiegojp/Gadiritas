...
<div class="flex justify-center w-full mt-4">
    <form action="" method="POST" class="w-3/4">
        ...
        <div class="flex items-center mb-4">
            <input id="is_guia" name="is_guia" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
